# At the top of global_areas.py
global TSJ_AREA_IM_DICT, TSJ_AREA_SM_DICT, TSJ_AREA_SS_DICT
global TSK_AREA_IM_DICT, TSK_AREA_SM_DICT, TSK_AREA_SS_DICT
global TSG_AREA_IM_DICT, TSG_AREA_SM_DICT
global TSM_AREA_IM_DICT, TSM_AREA_SM_DICT, TSM_AREA_SS_DICT

# Global Dictionaries for TSJ
TSJ_AREA_IM_DICT = {
    'C': 'C-Blast Furnace',
    'E': 'E-Blast Furnace',
    'F': 'F-Blast Furnace',
...
TSJ_AREA_SS_DICT = [
    'IMMM', 'SMMM', 'MMM', 'Central services',
    'IMEM', 'SMEM', 'Steel CG1', 'MEM',
    'Mills CG2', 'Utilities', 'PH3', 'PH4',
    'DG', 'PH5 & CDQ', 'BPH', 'FMD',
    'WMD', 'SMG', 'Engg Services',
    'EQMS Own', 'EQMS customer', 'Others'
]

# Global Dictionaries for TSG
TSG_AREA_IM_DICT = [
    'RMHS', 'Pellet', 'DRI', 'Coke', 
    'Sinter', 'Blast Furnace'
]

TSG_AREA_SM_DICT = [
    'SMS', 'WRM', 'Bloom', 'Bar', 'Wire'
]

# Global Dictionaries for TSK
TSK_AREA_IM_DICT = {
...
TSM_AREA_SS_DICT = [
    'RMHS & RMPP', 'CO-1', 'CO-2', 'SP-1',
    'SP-2&3', 'BF-1', 'BF-2', 'DRI',
    'Lime Plant', 'SMS', 'HSM ', '110 MW',
    'BFPP-1', 'BFPP-2', 'AEL (Before Merger)',
    'Oxygen Plant', 'Common Services (incl. Utility)',
    'CRM-Angul', 'CRM-Khopoli', 'CRM-Sahibabad'
]

def get_location_context(location):
    print("==================INSIDE GET LOCATION CONTEXT==================")
    ...
    print("==================END GET LOCATION CONTEXT==================")
    print(context)
